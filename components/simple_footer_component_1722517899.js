...
*/
Vue.component("simple_footer_component_1722517899", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BlockScan - Blockchain Intelligence Platform
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with BlockScan's cutting-edge blockchain analysis tools. Gain real-time insights into new blockchain data and transactions across multiple networks. Powered by AI for maximum efficiency.
                    </div>
                </div>
            </div>
        </footer> 
